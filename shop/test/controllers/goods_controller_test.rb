...
class GoodsControllerTest < ActionController::TestCase
  ...
  test "should create good" do
    assert_difference('Good.count') do
      post :create, good: { description: @good.description, how_many: @good.how_many, price: @good.price, title: @good.title }
    end
  ...
  test "should update good" do
    patch :update, id: @good, good: { description: @good.description, how_many: @good.how_many, price: @good.price, title: @good.title }
    assert_redirected_to good_path(assigns(:good))
  end
